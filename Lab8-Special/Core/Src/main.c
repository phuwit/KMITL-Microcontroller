...
int main(void)
{
  ...
  while (1)
  {
    ...
    if (screen == 0) {
      ...
      ILI9341_Draw_Text(infoScreenLine1, 144, 64 + (32*0), mixedColor, 2, WHITE);
      ILI9341_Draw_Text(infoScreenLine2, 144, 64 + (32*1), mixedColor, 2, WHITE);
      ILI9341_Draw_Text(infoScreenLine3, 144, 64 + (32*2), mixedColor, 2, WHITE);
      ILI9341_Draw_Text(infoScreenLine4, 144, 64 + (32*3), mixedColor, 2, WHITE);
